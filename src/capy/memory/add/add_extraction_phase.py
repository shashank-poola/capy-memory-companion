...
from capy.memory.extractor import extract_memories
from capy.utils.summary_generator import generate_conversation_summary

def extraction_phase(db: Session, messages: List[dict], conversation_id: int):
    """
    Extraction phase of CapyMemory add() - extracts both semantic facts and episodic bubbles
    """
